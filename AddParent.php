...
<body>
  ...
  <hr>
	...
	<form method="post" action="AddParent.php">
		...
		<label>Select Student:</label>
			<select name="PupilsID">
				...
				$sql = mysqli_query($link, "SELECT PupilsID, StudentName FROM Pupils");
	...
	if (isset($_POST['submit'])) {
		...
		$sql = "INSERT INTO Parents (ParentsID, ParentName, Par_Address, Email, Telephone, PupilsID) VALUES ('$ParentsID' ,'$ParentName', '$Par_Address', '$Email', '$Telephone', '$PupilsID')";
