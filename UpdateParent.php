...
<body>
  ...
  <hr>
    ...
    if (isset($_POST['submit'])) {
		...
		$sql = "UPDATE Parents SET ParentName = '$ParentName', Par_Address = '$Par_Address', Email = '$Email', Telephone = '$Telephone' WHERE ParentsID = '$ParentsID'";
